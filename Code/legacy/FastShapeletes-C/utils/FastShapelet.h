...
// typedef tuple<double,double,double,int,int,SAX_word_type, SAX_id_type, int>
// Tuple;
...
double CalInfoGain1(vector<int> const &, vector<int> const &, int const &,
                    int const &);

///// new function still in doubt
double EntropyArray(vector<int> const &, int const &);
double CalInfoGain2(vector<int> const &, vector<int> const &, int const &,
                    int const &);

Shapelet FindBestSAX(int, bool);

void ReadTrainData(char *);
void CreateSAXList(int, int, int);
// void ReadTrainData(char* filename, Data_type &Data, vector<int> &Label,
// vector<int> &Class_Freq);
// void CreateSAXList(int subseq_len, int sax_len, int w, Data_type const&
// Data);
