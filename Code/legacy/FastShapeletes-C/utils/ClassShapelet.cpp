...
// Removing default values since they're causing ng compiler problems
// due to ambiguous constructor [20APR2017:MAV]
Shapelet::Shapelet(double gain, double gap, double dist_th, int obj, int pos, int len, int num_diff)
{
    this->gain = gain;
    this->gap = gap;
