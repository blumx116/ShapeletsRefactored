...
% Path to results
UCR_RESULTS_PATH = '../Ben_UCR_Results/replications/';
    ...
    for i1 = 1:3
        for i2 = 1:2
            for i3 = 1:2
                ...
                all_accuracies{i1}{i2}{i3}{k} = accuracies;
...
save('Ben_UCR_Results.mat', 'master_accuracy_table', 'file_component_names', ...
    'master_accuracy_columns', 'master_accuracy_rows', 'incomplete_datasets', 'all_accuracies');